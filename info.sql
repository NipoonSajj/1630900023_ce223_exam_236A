...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3927968974ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nodejs_lottery&table=info">`nodejs_lottery`.`info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nodejs_lottery&table=information">`nodejs_lottery`.`information`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nodejs_lottery&table=%E0%B8%82%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%B9%E0%B8%A5">`nodejs_lottery`.`ข้อมูล`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=register_db&table=user">`register_db`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="567760333c7b32525f6b62666f6a7429">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="nodejs_lottery" targettable="info">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `info`  
ORDER BY `info`.`prize` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nodejs_lottery" targettable="info">
                            <div class="action_content">
...
ORDER BY `info`.` date`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `info` DROP `id`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nodejs_lottery" targettable="info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `info` ADD PRIMARY KEY(`id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nodejs_lottery" targettable="info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `info` WHERE (`info`.`id` = &#039;003392&#039;) OR (`info`.`id` = &#039;020974&#039;) OR (`info`.`id` = &#039;027001&#039;) OR (`info`.`id` = &#039;036686&#039;) OR (`info`.`id` = &#039;046457&#039;) OR (`info`.`id` = &#039;050015&#039;) OR (`info`.`id` = &#039;054035&#039;) OR (`info`.`id` = &#039;103342&#039;) OR (`info`.`id` = &#039;127728&#039;) OR (`info`.`id` = &#039;129232&#039;) OR (`info`.`id` = &#039;141817&#039;) OR (`info`.`id` = &#039;158303&#039;) OR (`info`.`id` = &#039;315090&#039;) OR (`info`.`id` = &#039;344527&#039;) OR (`info`.`id` = &#039;358202&#039;) OR (`info`.`id` = &#039;362277&#039;) OR (`info`.`id` = &#039;395919&#039;) OR (`info`.`id` = &#039;413&#039;) OR (`info`.`id` = &#039;440807&#039;) OR (`info`.`id` = &#039;508&#039;) OR (`info`.`id` = &#039;542136&#039;) OR (`info`.`id` = &#039;559912&#039;) OR (`info`.`id` = &#039;563497&#039;) OR (`info`.`id` = &#039;578&#039;) OR (`info`.`id` = &#039;642745&#039;)   </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nodejs_lottery" targettable="info">
                            <div class="action_content">
